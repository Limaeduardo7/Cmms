...
const Dashboard = () => {
  ...
  const [analysisType, setAnalysisType] = useState('Visão Geral');
  const [isLoading, setIsLoading] = useState(true);
  const [isModalOpen, setModalOpen] = useState(false);

  useEffect(() => {
    const timer = setTimeout(() => setIsLoading(false), 1000); // Simulates an API call delay
  ...
  const indicators: Indicator[] = [
    { label: 'Disponibilidade', value: '99.68%' },
    { label: 'Confiabilidade', value: '75.04%' },
  ...
  return (
    <div className="w-full">
      <Header />
      <h1 className="text-3xl font-bold text-white mt-20 ml-4">Dashboard de Análise de Dados</h1>
        ...
        <div className="px-4 py-4 mt-4 bg-transparent">
          <div className="flex justify-between items-center mb-4">
            <div className="flex gap-2">
              {['Visão Geral', 'Análise de Fourier', 'Análise de Tendências', 'Análise Preditiva', 'Análise de Correlação'].map((type, index) => (
                <button
                  key={index}
                  ...
                  <form className="p-4 md:p-5">
                    <div className="grid gap-4 mb-4 grid-cols-2">
                      ...
                      <div className="col-span-2">
                        <label htmlFor="startDate" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data Inicial</label>
                      ...
                      <div className="col-span-2">
                        <label htmlFor="equipmentType" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo de Equipamento</label>
                      ...
                      <div className="col-span-2">
                        <label htmlFor="maintenanceStatus" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status de Manutenção</label>
                      ...
                      <div className="col-span-2">
                        <label htmlFor="maintenancePriority" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Prioridade de Manutenção</label>
          ...
          <div className="w-full h-screen">
            {analysisType === 'Visão Geral' ? (
              ...
              <LineChart data={[]} title={`Análise ${analysisType}`} theme={theme} />
            )}
          </div>
        </div>
      )}
